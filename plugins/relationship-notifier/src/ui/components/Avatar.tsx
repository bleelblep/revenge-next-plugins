 ...
 *
 * Deliberately not using Discord's default-avatar CDN images: picking the right one requires
 * BigInt arithmetic on the snowflake, and an initial is both cheaper and clearer at this size.
 */
