 ...
 *
 * Copied from screenshot-redactor-dev. Called like a hook (`useSafeAreaInsets` is one), so
 * call it unconditionally at the top of the component, and only ever from a render -- see
