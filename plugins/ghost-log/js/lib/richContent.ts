...
// Kept for a future rework, but intentionally disabled in this release.
const RICH_CONTENT_SIDECAR_ENABLED = false
...
export function saveRichContent(
	...
	if (!RICH_CONTENT_SIDECAR_ENABLED || !settings.saveEmbeds) return
